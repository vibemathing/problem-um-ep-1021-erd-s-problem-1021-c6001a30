...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1021-erd-s-problem-1021-c6001a30-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1021"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1021-erd-s-problem-1021-c6001a30-v1",
      "problem_contract_sha256": "cd6acb4f1b6642658bae9bb2df216f61a9da35e173a4fd4027d0e8fff1d81a58",
      "problem_id": "problem:um-ep-1021-erd-s-problem-1021-c6001a30",
      "route_id": "route:um-ep-1021-erd-s-problem-1021-c6001a30-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1021-erd-s-problem-1021-c6001a30-source-fidelity-01",
      "graph_id": "graph:um-ep-1021-erd-s-problem-1021-c6001a30-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1021-erd-s-problem-1021-c6001a30-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1021-erd-s-problem-1021-c6001a30-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is it true that, for every $k\\geq 3$, there is a constant $c_k>0$ such that $ \\mathrm{ex}(n,G_k) \\ll n^{3/2-c_k}, $ where $G_k$ is the bipartite graph between $\\{y_1,\\ldots,y_k\\}$ and $\\{z_1,\\ldots,z_{\\binom{k}{2}}\\}$, with each $z_j$ joined to a unique pair of $y_i$?"
          },
          "statement_sha256": "791938ab377ad118440b2714d54d1e77f3d6c65debb06c2be0415a530bd49ac7"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1021-erd-s-problem-1021-c6001a30-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1021-erd-s-problem-1021-c6001a30-root",
      "route_id": "route:um-ep-1021-erd-s-problem-1021-c6001a30-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1021-b1ec82b8cc1f",
        "url": "https://www.unsolvedmath.com/problems/EP-1021"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
